  ...
  <div class="account-settings">
    ...
    <div class="settings-section">
      ...
      <div class="section-content">
        <div class="setting-item switch-item">
          <div class="setting-label">
            <span class="label-text">允许他人查看我的收藏</span>
          </div>
          <div class="setting-value">
            <label class="switch">
              <input type="checkbox" v-model="privacySettings.allowViewFavorites">
        ...
        <div class="setting-item switch-item">
          <div class="setting-label">
            <span class="label-text">允许他人查看我的浏览历史</span>
          </div>
          <div class="setting-value">
            <label class="switch">
              <input type="checkbox" v-model="privacySettings.allowViewHistory">
              <span class="slider"></span>
            </label>
          </div>
        </div>
        ...
        <div class="setting-item switch-item">
          <div class="setting-label">
            <span class="label-text">允许通过手机号搜索到我</span>
          </div>
          <div class="setting-value">
            <label class="switch">
              <input type="checkbox" v-model="privacySettings.allowSearchByPhone">
              <span class="slider"></span>
            </label>
          </div>
        </div>
    ...
    <div class="settings-section">
      ...
      <div class="section-content">
        ...
        <div class="setting-item switch-item">
          <div class="setting-label">
            <span class="label-text">互动通知</span>
          </div>
          <div class="setting-value">
            <label class="switch">
              <input type="checkbox" v-model="notificationSettings.interaction">
              <span class="slider"></span>
            </label>
          </div>
        </div>
        ...
        <div class="setting-item switch-item">
          <div class="setting-label">
            <span class="label-text">活动通知</span>
          </div>
          <div class="setting-value">
            <label class="switch">
