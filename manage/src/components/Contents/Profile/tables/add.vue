...
const handleConfirm = async () => {
    ...
    try {
        form.status = currentStatus.value || 0
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" :title="props.title" width="800">
        <el-form :model="form" ref="formRef" :rules="rules" label-position="right">
            ...
            <el-form-item label="资讯内容" :label-width="formLabelWidth" prop="content">
                <el-input v-model="form.content" type="textarea" :rows="10" placeholder="请输入资讯内容（富文本/图文混排）" />
            </el-form-item>
        </el-form>
